...
function DeblocageSuccessContent() {
      ...
      <div className="max-w-sm w-full text-center bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        {status === 'checking' && (
          <>
            ...
            <p className="text-sm text-gray-400">Un instant, on debloque votre contact.</p>
          </>
        )}
        {status === 'confirmed' && (
          <>
            <CheckCircle2 className="w-10 h-10 mx-auto mb-4 text-green-500" />
            <p className="font-bold text-gray-900 mb-1">Contact debloque !</p>
        ...
        {status === 'timeout' && (
          <>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Ca prend parfois quelques instants de plus. Reessayez dans une minute.
            </p>
            <button
