      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
          <div className="bg-slate-800/60 border border-slate-700/70 p-6 rounded-2xl flex items-center gap-5">
            ...
            <div><span className="block text-xs font-bold text-slate-400 uppercase tracking-wide">En attente</span><span className="text-2xl font-black text-white">{metrics.pendingCount}</span></div>
          </div>
          <div className="bg-slate-800/60 border border-slate-700/70 p-6 rounded-2xl flex items-center gap-5">
            <div className="p-3 bg-emerald-500/10 text-emerald-400 rounded-xl"><Briefcase className="w-6 h-6" /></div>
            <div><span className="block text-xs font-bold text-slate-400 uppercase tracking-wide">Valides</span><span className="text-2xl font-black text-white">{metrics.totalArtisans}</span></div>
          </div>
          <div className="bg-slate-800/60 border border-slate-700/70 p-6 rounded-2xl flex items-center gap-5">
        ...
        {filteredProfiles.length === 0 ? (
          <div className="bg-slate-800/30 border border-slate-800 text-center py-16 rounded-2xl">
            ...
            <p className="text-sm text-slate-400 font-medium">Aucun resultat pour cette selection.</p>
          </div>
        ) : (
